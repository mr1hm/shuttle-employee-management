    ...
    return (
      <React.Fragment>
        ...
        <Modal open={this.state.isModalOpen} status={this.state.activeModal} shiftStatus={this.state.shiftsDetailsInfo.status}>
          ...
          <p><button  onClick={() => this.postShift('unscheduled', 1, 1)} >Yes, I want to post</button></p> {/* Need to make fetch call to hit driver-shift endpoint to switch shifts from scheduled to posted*/}
        </Modal>
      </React.Fragment>
    )
  }
