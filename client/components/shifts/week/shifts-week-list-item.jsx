...
import { calcShiftLenghtInHourMinFormat, convertMilitaryTime, globalDayOfWeekShort } from '../../../lib/time-functions';
import RouteBusDisplay from '../../route-bus-display';

class WeekListItem extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      swapFlag: 0
  ...
  render() {
    ...
    const day = globalDayOfWeekShort[dateObj.getUTCDay()];
