      ...
      fetch('api/admin-lines-buses.php', init)
        ...
        .then(sessionData => {
          this.setState({
            ...
            this.getLinesBusesInfo({ session_id: sessionID }); // not staying on the selected session when adding new line.
          });
        })
        .catch(error => console.error(error));
    }
