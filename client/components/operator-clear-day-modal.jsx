      ...
      <div className={this.props.clearShow ? 'modal display-block' : 'modal display-none'}>
        <section className='modal-main'>
          ...
          <div className="d-flex justify-content-center">
            <button className="btn btn-primary center-block mb-3" onClick={this.props.closeClear}>Yes Clear</button>
            <button className="btn btn-primary center-block mb-3" onClick={this.props.cancelClear}>Cancel</button>
          </div>
        </section>
      </div>
    );
